...
%% Coil 10mm
HW.RX2TXdeadTime = 3e-6;         % Receiver deadtime before TX pulse in s (old 1e-6)
HW.TX2RXdeadTime = 4e-6;        % Receiver deadtime after TX pulse in s e.g. ringing of Coil ~40 µs (Old : 5e-6)
HW.TX.BlankOffset = 700e-9;      % Unblank of RF-100 before TX pulse (old 800e-9)
...
HW.TX.BlankAQ = 1;               % Switch TRx to 50 Ohm resistor during TX pulse, to avoid saturation. old 1

%% RX Settings
HW.RX.VGAGainDef = HW.RX.VGAGainMax/1; % reduce VGA gain to avoid saturation
disp(HW.RX.VGAGainDef)
